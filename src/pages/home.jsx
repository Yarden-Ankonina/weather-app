...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className='flex absolute rounded-3xl shadow-xl shadow-slate-700 top-10 m-3 opacity-75 w-1/2 h-3/4 justify-center p-2 text-lg font-medium  '  style={{backgroundImage: "url(https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80)", backgroundSize : "cover"}}>
                {cityForcast.name}
        ...
        <div className='z-10 flex flex-col items-center justify-around border-2 border-solid bg-sky-50 border-stone-400 p-3 dark:bg-transparent shadow-xl dark:border-slate-700 rounded dark:border-4 dark:bg-neutral-900 ' style={{backgroundColor :"rgba(180,200,200,60%)"}}>
          <div className='flex p-3 dark:text-slate-100 justify-between'>
            <div className='flex items-center'>
            </div>
            <div className='flex flex-col items-center'>
              <div className='mr-2 mb-2 text-4xl text-black'>&hearts;</div>
              <button className='shadow border border-slate-200 dark:border-slate-800 bg-transparent shadow-slate-400 rounded p-1 dark:text-slate-200 hover:bg-slate-100 hover:dark:bg-slate-700' >Add To Favourites</button>
            </div>
          </div>
