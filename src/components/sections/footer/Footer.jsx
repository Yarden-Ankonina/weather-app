...
export default function Footer() {
  ...
  return (
    <>
    <div className='flex justify-between items-center dark:bg-neutral-900 bg-slate-100 border-t border-slate-400 h-fit p-0.5 fixed w-full bottom-0 text-slate-200 '>
      <div className='flex items-center'>
        ...
        <div className='text-xs mr-2 dark:text-slate-500 align-middle text-black'>This app uses <a className=' italic' target="_blank" href='https://icons8.com/'>https://icons8.com/</a></div>
      </div>
    </>
  )
}
